...
package dk.trustworks.essentials.types.springdata.jpa;

import dk.trustworks.essentials.types.*;
import dk.trustworks.essentials.types.springdata.jpa.model.Order;
import dk.trustworks.essentials.types.springdata.jpa.model.*;
