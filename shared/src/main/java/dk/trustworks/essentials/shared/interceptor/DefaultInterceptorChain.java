...
package dk.trustworks.essentials.shared.interceptor;
...
public final class DefaultInterceptorChain<OPERATION, RESULT, INTERCEPTOR_TYPE extends Interceptor> implements InterceptorChain<OPERATION, RESULT, INTERCEPTOR_TYPE> {
    private static final Logger                                                                                      log = LoggerFactory.getLogger(dk.trustworks.essentials.shared.interceptor.DefaultInterceptorChain.class);
