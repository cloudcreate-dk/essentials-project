...
import static dk.trustworks.essentials.shared.Exceptions.sneakyThrow;
 ...
 *
 * <b>Logging</b>
 * Using a setup where the {@link PatternMatchingMethodInvoker} is invoking methods on an instance of <code>dk.trustworks.handlers.OrderEventsHandler</code>
 * <pre>{@code
 * var patternMatchingInvoker = new PatternMatchingMethodInvoker<>(new dk.trustworks.handlers.OrderEventsHandler(),
 *                                                                 new SingleArgumentAnnotatedMethodPatternMatcher(EventHandler.class,
 *                                                                                                                 OrderEvent.class),
 *                                                                 InvocationStrategy.InvokeMostSpecificTypeMatched,
 *                                                                 Optional.empty());
 * }</pre>
 * and you want {@link PatternMatchingMethodInvoker} logging then you should set the logging level for <code>dk.trustworks.handlers.OrderEventsHandler</code> to <code>TRACE</code><br>
 * <br>
 *
