...
import dk.trustworks.essentials.components.eventsourced.aggregates.snapshot.AggregateSnapshot;
...
/**
 * A modern opinionated interpretation of the classic {@link dk.trustworks.essentials.components.eventsourced.aggregates.stateful.classic.AggregateRoot} design, where the {@link Event}'s are mutable.<br>
