...
class AppendToStream<ID> {
     ...
     *                                    to resolve the {@link EventOrder} of the last persisted event for this aggregate instance.
     */
    public void setAppendEventsAfterEventOrder(Long appendEventsAfterEventOrder) {
     ...
     *                                    to resolve the {@link EventOrder} of the last persisted event for this aggregate instance.
     */
    public void setAppendEventsAfterEventOrder(GlobalEventOrder appendEventsAfterEventOrder) {
