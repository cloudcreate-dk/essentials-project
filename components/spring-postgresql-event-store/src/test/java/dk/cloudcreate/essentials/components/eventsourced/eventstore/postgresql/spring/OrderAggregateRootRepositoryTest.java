...
@Testcontainers
abstract class OrderAggregateRootRepositoryTest {
    ...
    protected abstract EventStoreUnitOfWorkFactory<? extends EventStoreUnitOfWork> createUnitOfWorkFactory();
    ...
    void springManagedTransaction_persist_and_load_OrderWithState_aggregate() {
        ...
        // When
        transactionTemplate.executeWithoutResult(status -> ordersRepository.save(order));
