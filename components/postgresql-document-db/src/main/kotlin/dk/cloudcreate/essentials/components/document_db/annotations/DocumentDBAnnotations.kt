...
import dk.cloudcreate.essentials.components.document_db.postgresql.Property
...
/**
 * @param tableName The name of the name of the postgresql table where entities annotated will be persisted.
 *
 * **Note:**
 * The [tableName] provided will be directly used in constructing SQL statements
 * through string concatenation, which exposes the components (such as
...
/**
 * Use this annotation on a concrete class implementing [dk.cloudcreate.essentials.components.document_db.VersionedEntity]
 * to specify the individual properties that should be indexed
 *
 * Example:
 * ```
 ...
 *
 * ### Security note:
 * The name of the property will be used in the index name (together with the table name specified in [DocumentEntity.tableName]) and futher used in constructing SQL statements
 * through string concatenation, which exposes the components (such as
 * [dk.cloudcreate.essentials.components.document_db.postgresql.PostgresqlDocumentDbRepository]) to SQL injection attacks.
 *
