...
import dk.trustworks.essentials.components.document_db.postgresql.*
 ...
 *
 * The  [dk.trustworks.essentials.components.foundation.postgresql.PostgresqlUtil.checkIsValidTableOrColumnName] provides an initial layer of defense against SQL injection by applying naming conventions intended to
...
interface DocumentDbRepository<ENTITY : VersionedEntity<ID, ENTITY>, ID> {
     ...
     *
     * The [PostgresqlDocumentDbRepository.addIndex] will call the [dk.trustworks.essentials.components.foundation.postgresql.PostgresqlUtil.checkIsValidTableOrColumnName] method to validate the index name
     * as a first line of defense.
     *
     * The  [dk.trustworks.essentials.components.foundation.postgresql.PostgresqlUtil.checkIsValidTableOrColumnName] provides an initial layer of defense against SQL injection by applying naming conventions
