 ...
 */
public abstract class ZonedDateTimeTypeArgumentFactory<T extends ZonedDateTimeType<T>> extends AbstractArgumentFactory<T> {
    public ZonedDateTimeTypeArgumentFactory() {
