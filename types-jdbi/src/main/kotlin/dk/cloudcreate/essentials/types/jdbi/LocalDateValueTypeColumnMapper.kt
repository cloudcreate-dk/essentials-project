...
/**
 * Generic [ColumnMapper] for [LocalDateValueType]'s
 *
...
abstract class LocalDateValueTypeColumnMapper<T : LocalDateValueType> : ColumnMapper<T?> {
    ...
    override fun map(r: ResultSet, columnNumber: Int, ctx: StatementContext): T? {
        val value = r.getDate(columnNumber)
        return if (value == null) null else concreteType.primaryConstructor!!.call(value.toLocalDate())
    }
}
