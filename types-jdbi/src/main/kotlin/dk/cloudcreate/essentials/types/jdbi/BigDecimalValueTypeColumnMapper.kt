...
import dk.cloudcreate.essentials.kotlin.types.BigDecimalValueType
...
abstract class BigDecimalValueTypeColumnMapper<T : BigDecimalValueType> : ColumnMapper<T?> {
    ...
    override fun map(r: ResultSet, columnNumber: Int, ctx: StatementContext): T? {
        val value = r.getBigDecimal(columnNumber)
        return if (value == null) null else concreteType.primaryConstructor!!.call(value)
    }
}
